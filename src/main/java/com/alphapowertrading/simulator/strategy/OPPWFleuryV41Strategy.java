...
@Component("fleuryv41")
public class OPPWFleuryV41Strategy implements Strategy {
  ...
  public OPPWFleuryV41Strategy () {
    this(0.010, 0.99, 0.01, 0.99);
  }

  public OPPWFleuryV41Strategy (double tp, double tph, double sl, double openGap) {
